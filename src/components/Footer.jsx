...
function Footer() {
  return (
    <footer className='w-full bg-[#0B0F19] text-white text-center py-6 px-10 relative z-10'>
    ...
    <ul className="flex justify-center mt-5 space-x-5">
        <li>
            <a href="#" className="text-gray-500 hover:text-[#e64f00]">
    ...
    <p className="text-gray-500 text-sm font-medium py-5">© 2026 Kubiks. All rights reserved. Developed by Shanid P</p>
</div>
    </footer>
  )
}
