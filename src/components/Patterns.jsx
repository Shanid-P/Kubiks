...
function Patterns() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] text-white selection:bg-orange-500/30 w-full py-20 relative overflow-hidden px-5 sm:px-8 md:px-15">
      ...
      <main className="max-w-7xl mx-auto px-5 items-center justify-center gap-12 pt-14 pb-10 w-full relative z-10">
        <div className="flex flex-col gap-2 w-full items-start justify-center mb-10">
          <h2 className="text-xs md:text-sm tracking-[0.25em] font-bold text-gray-400 uppercase">The Pattern Gallery</h2>
