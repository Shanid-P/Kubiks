...
function SolverPage() {
  ...
  return (
    ...
    `,
        ...
        <div className="flex items-center gap-30 justify-between mt-8 w-full">
          <div className="flex flex-col gap-1">
            <p className="text-md text-slate-500">Are you got tired of painting Cube?</p>
            <span className="text-4xl md:text-5xl font-black leading-[0.9] tracking-normal ">Scan your
          ...
          <div>
            <img src="/assets/cubeDia.png" className='w-30' alt="" />
          </div>
          <div className="h-full">
            <button
              // onClick={}
              className="bg-[#0496c7] hover:bg-[#e64f00] text-black text-lg font-bold px-8 py-3 rounded-sm uppercase tracking-widest transition-all"
            >
              <FontAwesomeIcon icon='expand' className="mr-3" />Scan
            </button>
          </div>
        </div>
        <div className="flex w-full mt-15 justify-between">
          <div className="flex relative flex-col gap-8 w-[50%] items-center justify-center">

            {/* <div className="absolute inset-0 bg-blue-500/70 blur-[1200px] rounded-full w-[500px] border" /> */}
            ...
            <div style={{
              ...
              className='relative z-20 flex-col gap-5'>
              <div
                id="heroCube"
              ...
              ></div>
              {/* <CubePlayer/> */}
              <p className="text-sm text-slate-500">[Your Cube - 3D view]</p>
            </div>
  ...
  <button
    className="flex gap-2 items-center justify-center bg-[#FF5800] hover:bg-[#e64f00] text-black text-sm font-bold px-5 py-2.5 rounded-sm uppercase tracking-widest transition-all"
  >
    <FontAwesomeIcon icon="play" />
    <p className="text-sm">Animate</p>
  </button>
<button
    className="flex gap-2 items-center justify-center bg-[#FF5800] hover:bg-[#e64f00] text-black text-sm font-bold px-5 py-2.5 rounded-sm uppercase tracking-widest transition-all"
  >
    <FontAwesomeIcon icon="arrow-right" />
    <p className="text-sm">Start Over</p>
  </button>
          ...
          <div className="flex flex-col w-[50%] items-start h-full gap-10">
            <div className="flex flex-col gap-3">
              <p className="text-xl font-extrabold uppercase">Moves</p>
              <div className="bg-[#050607] px-10 py-5 border border-slate-500  text-white rounded-lg tracking-widest text-lg w-[70%] h-50 overflow-y-auto">
                {solution ? solution : <span className="text-slate-600">Enter your cube layout and click Solve Now to see the moves here...</span>}
              </div>
              <p className="mt-3 text-slate-500">The method of Solving | Kociemba Solution</p>
            </div>



            <div className="flex gap-10 items-center justify-start w-[70%]">
